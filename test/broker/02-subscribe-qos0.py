...
connect_packet = pack('BBBB6sBBBBBB19s', 16, 12+2+19,0,6,"MQIsdp",3,2,0,60,0,19,"subscribe-qos0-test")
connack_packet = pack('BBBB', 32, 2, 0, 0);

subscribe_packet = pack('BBBBBB9sB', 130, 2+2+9+1, 0, 1, 0, 9, "qos0/test", 0)
suback_packet = pack('BBBBB', 144, 2+1, 0, 1, 0)
