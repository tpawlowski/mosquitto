        ...
        if publish_recvd != publish_packet:
            ...
            if connect_recvd != connect_packet:
                ...
                if publish_recvd != publish_packet_dup:
                    print("FAIL: Received incorrect retried publish.")
                    print("Received: "+mqtt_decode.mqtt_decode(publish_recvd))
                    print("Expected: "+mqtt_decode.mqtt_decode(publish_packet_dup))
                else:
