...
LIB_CFLAGS:=${CFLAGS} -I. -I.. -I../lib ${CPPFLAGS}
LIB_CXXFLAGS:=$(LIB_CFLAGS) ${CPPFLAGS}

BROKER_CFLAGS:=${LIB_CFLAGS} -DVERSION="\"${VERSION}\"" -DTIMESTAMP="\"${TIMESTAMP}\"" -DWITH_BROKER ${CPPFLAGS}
CLIENT_CFLAGS:=${CFLAGS} -I../lib -DVERSION="\"${VERSION}\"" ${CPPFLAGS}
